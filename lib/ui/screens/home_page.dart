  ...
  Future<void> _copyLatestToToday() async {
    ...
    if (newDate == null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Nothing to copy (latest is already today)'),
        ),
      );
      return;
    }
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('Copied to $newDate')));
  }
  ...
  Future<void> _deleteCurrentDate() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Delete the entire collection for $_currentDate?'),
        actions: [
          TextButton(
              ...
              children: [
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Center(
                          child: Text(
                            _currentDate.isEmpty ? 'No date' : _currentDate,
                ...
                Padding(
                  ...
                  child: SegmentedButton<bool>(
                    segments: const [
                      ButtonSegment<bool>(value: true, label: Text('Assets')),
                      ButtonSegment<bool>(
                        value: false,
                  ...
                  child: PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final list = _showAssets
                          ...
                          : (entry?.liabilities ?? const <FinancialItem>[]);
